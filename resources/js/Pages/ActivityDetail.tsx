      ...
      <section className="max-w-6xl mx-auto py-12 md:py-20 space-y-6">
        ...
        <div className="flex justify-between gap-8 items-start">
          <div className="space-y-6 w-1/2">
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-md font-medium">{activity[0].max} Relawan</p>
            </div>
          </div>
          ...
          <Card className="w-1/2 p-2 space-y-6">
            ...
            <CardHeader>
              {/* Event Title */}
              <h1 className="text-3xl font-bold">{activity[0].title}</h1>

              {/* Badges */}
              <div className="flex flex-wrap gap-2 mt-2">
                {JSON.parse(activity[0].category).map((category: string) => (
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-gray-700">
                    <strong>Jadwal Event:</strong> {formatDate(activity[0].schedule)}
                  </p>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-gray-700">
                    <strong>Lokasi:</strong> {activity[0].location}
                  </p>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-red-500">
                    <strong>Batas Registrasi:</strong> {formatDate(activity[0].deadline)}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <Button className="bg-primary w-full">Jadi Relawan</Button>
        ...
        <div className="flex-col space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p className="text-gray-600">{activity[0].description}</p>
          </div>

          {/* Activity[0] Details */}
          <div>
            <h2 className="text-2xl font-bold">Detail Aktivitas</h2>
            <Card className="mt-2">
              <CardHeader>
                <h3 className="text-lg font-bold">Metode Briefing</h3>
              </CardHeader>
              <CardContent>
                <p>-</p>
              </CardContent>
